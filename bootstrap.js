...
/******/ 				var req = fetch(__webpack_require__.p + "" + {"./pkg/index_bg.wasm":"e48042460625bace0492"}[wasmModuleId] + ".module.wasm");
/******/ 				var promise;
...
eval("// A dependency graph that contains any wasm must all be imported\n// asynchronously. This `bootstrap.js` file does the single async import, so\n// that no one else needs to worry about it again.\nPromise.all(/*! import() */[__webpack_require__.e(2), __webpack_require__.e(1)]).then(__webpack_require__.bind(null, /*! ./index.js */ \"./js/index.js\"))\n  .catch(e => console.error(\"Error importing `index.js`:\", e));\n\n\n//# sourceURL=webpack:///./js/bootstrap.js?");
